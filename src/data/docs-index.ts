...
const cdkDocsIndex: DocumentSuggestion[] = [
  {
    filename: "cdk-app-shell--docs.md",
    title: "AppShell",
  ...
  { filename: "cdk-layout--docs.md", title: "Layout", description: "CSS grid and flex layout" },
];

const styleDocsIndex: DocumentSuggestion[] = [
  { filename: "styles-icon--docs.md", title: "Icons", description: "Full catalog of supported icon names and their metaphor" },
];

const componentDocsIndex: DocumentSuggestion[] = [
  { filename: "components-badge-counter-badge--docs.md", title: "Counter Badge", description: "A counter badge is a badge that displays a numerical count." },
  {
    filename: "components-badge-presencebadge--docs.md",
    title: "PresenceBadge",
    description: "A presence badge is a badge that displays a status indicator such as available, away, or busy.",
  },
  {
    filename: "components-badge-badge--docs.md",
    title: "Badge",
    description:
  ...
  { filename: "components-button-button--docs.md", title: "Button", description: "A button triggers an action or event when activated." },
  {
    filename: "components-accordion--docs.md",
    title: "Accordion",
    description: "An accordion allows users to toggle the display of content by expanding or collapsing sections.",
  },
  {
    filename: "components-avatar--docs.md",
    title: "Avatar",
    description:
  ...
  {
    filename: "components-button-compoundbutton--docs.md",
  ...
  {
    filename: "components-card-cardfooter--docs.md",
    title: "CardFooter",
    description:
  ...
  {
    filename: "components-card-cardheader--docs.md",
    title: "CardHeader",
    description: "The CardHeader component, used inside of a Card, represents a Fluent UI compliant card header.",
  },
  { filename: "components-button-togglebutton--docs.md", title: "ToggleButton", description: "A toggle button is a button that can be checked on and off." },
  {
    filename: "components-button-splitbutton--docs.md",
    title: "SplitButton",
    description: "A split button is a button with a primary action and a secondary action primarily used for opening a menu.",
  },
  {
    filename: "components-card-card--docs.md",
    title: "Card",
    description:
  ...
  {
    filename: "components-checkbox--docs.md",
    title: "Checkbox",
    description:
  ...
  { filename: "components-divider--docs.md", title: "Divider", description: "A divider visually separates two pieces of content." },
  {
    filename: "components-dialog--docs.md",
    title: "Dialog",
    description:
  ...
  {
    filename: "components-fluentprovider--docs.md",
  ...
  {
    filename: "components-combobox--docs.md",
    title: "Combobox",
  ...
  {
    filename: "components-dropdown--docs.md",
    title: "Dropdown",
    description:
  ...
  { filename: "components-field--docs.md", title: "Field", description: "Field adds a label, validation message, and hint text to a control." },
  { filename: "components-image--docs.md", title: "Image", description: "An image displays graphical content such as a photo or illustration." },
  {
    filename: "components-drawer--docs.md",
    title: "Drawer",
    description:
  ...
  {
    filename: "components-infolabel--docs.md",
    title: "InfoLabel",
    description:
  ...
  { filename: "components-label--docs.md", title: "Label", description: "A label provides a name or title for an input." },
  {
    filename: "components-link--docs.md",
    title: "Link",
  ...
  { filename: "components-input--docs.md", title: "Input", description: "Input allows the user to enter and edit text." },
  {
    filename: "components-menu-menulist--docs.md",
    title: "MenuList",
    description: "A menu list displays a list of actions. It is usually rendered inside of the Menu component.",
  },
  { filename: "components-datagrid--docs.md", title: "DataGrid", description: "" },
  {
    filename: "components-messagebar--docs.md",
    title: "MessageBar",
    description:
  ...
  {
    filename: "components-portal-portal--docs.md",
    title: "Portal",
    description:
  ...
  {
    filename: "components-persona--docs.md",
    title: "Persona",
  ...
  {
    filename: "components-portal-tomountnodeprops--docs.md",
  ...
  { filename: "components-popover--docs.md", title: "Popover", description: "A popover displays content on top of other content." },
  {
    filename: "components-overflow--docs.md",
    title: "Overflow",
    description:
  ...
  {
    filename: "components-menu-menu--docs.md",
    title: "Menu",
  ...
  {
    filename: "components-rating--docs.md",
    title: "Rating",
    description:
  ...
  {
    filename: "components-ratingdisplay--docs.md",
    title: "RatingDisplay",
    description:
  ...
  {
    filename: "components-searchbox--docs.md",
    title: "SearchBox",
    description:
  ...
  {
    filename: "components-select--docs.md",
    title: "Select",
  ...
  {
    filename: "components-skeleton--docs.md",
    title: "Skeleton",
    description:
  ...
  {
    filename: "components-spinner--docs.md",
    title: "Spinner",
  ...
  {
    filename: "components-switch--docs.md",
    title: "Switch",
    description:
  ...
  {
    filename: "components-swatchpicker--docs.md",
    title: "SwatchPicker",
    description: "A swatch picker lets people choose a color, image, or pattern and apply it to graphics or text.",
  },
  { filename: "components-tag-tag--docs.md", title: "Tag", description: "A Tag provides a visual representation of an attribute, person, or asset." },
  {
    filename: "components-tag-interactiontag--docs.md",
  ...
  { filename: "components-textarea--docs.md", title: "Textarea", description: "Textarea allows the user to enter and edit multiline text." },
  {
    filename: "components-text--docs.md",
    title: "Text",
  ...
  {
    filename: "components-tooltip--docs.md",
    title: "Tooltip",
    description:
  ...
  {
    filename: "components-tree--docs.md",
    title: "Tree",
    description:
  ...
  { filename: "components-table--docs.md", title: "Table", description: "" },
];
